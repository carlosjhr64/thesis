...
The Hermite polynomial:
    ...
    # Proof:
      ...
      (-1)ⁿ (D[ℯ[ξ²]] (D)ⁿ ℯ[-ξ²] + ℯ[ξ²] (D)ⁿ D[ℯ[-ξ²]])   # Well... obviously!
      ...
      (-1)ⁿ (2ξℯ[ξ²] (D)ⁿ ℯ[-ξ²] + ℯ[ξ²] Σ[0,n]{m| (ⁿₘ) (D)ᵐ[-2ξ] (D)ⁿ-ᵐℯ[-ξ²]})
    ...
    # Also a well known property of ℋ, but here's a proof:
      ...
      (-1)ⁿ ℯ[ξ²] Σₘ (ⁿₘ) (D)ᵐ[2ξ] (D)ⁿ-ᵐ[ℯ[-ξ²]]
...
Note that Δx and Δp represent Real numbers and can be calculated separately:
    ...
    <Ψ|n><n|ΔxΔp|m><m|Ψ>
    <Ψ|n><n|Δx|m><m|Ψ> × <Ψ|n><n|Δp|m><m|Ψ>
    √ (<Ψ|n><n|x²|m><m|Ψ> - (<Ψ|n><n|x|m><m|Ψ>)² ) × (<p²>-<p>²)
    √ (<x²>-<x>²)(<p²>-<p>²)
...
I can set `<x>=0` and `<p>=0` and by symmetry that `<x²>` goes as `<p²>`
(in dimensionless setting `<x²>=<p²>`).
Then the problem is:

    Minimize:   <x²>
    Subject to: <n>=ñ,<x²>=<p²>   # TODO: got this far. OK?
