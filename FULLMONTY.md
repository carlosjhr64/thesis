...
##<a name="eVh"></a> ⧼𝐩⧽
    ...
    ⁇⨋ (𝑝Ψ)*(-𝑖𝒟) 𝑝ₘΨₘ               # Change of variable from x to ξ.
    ⁇⨋ (𝑝Ψ)*(-𝑖𝑝ₘ𝒟 Ψₘ)               # Rearrange.
    ⁇⨋ (𝑝Ψ)*(-𝑖𝑝ₘ√½(√ʼm↧Ψₘ↓-√m↥Ψₘ↑))
    ⁇⨋ (-𝑖𝑝*𝑝ₘ√½(√ʼm↧ΨΨₘ↓-√m↥ΨΨₘ↑))
    ⁇⅀ (-𝑖𝑝*𝑝ₘ√½(√ʼm↧𝛿↓-√m↥𝛿↑))
    ⁇⅀ (-𝑖𝒫 √½(√ʼm↧𝛿↓-√m↥𝛿↑))
...
> TODO: I don't think I've been keeping proper track of `𝑝*`.
> 𝒫 is `𝑝ₙ*𝑝ₘ`, there's a conjugation.
> And what's the constant here `⁇`?
